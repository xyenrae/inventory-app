...
import { LayoutGrid, Menu, Search, Settings, LogOut } from 'lucide-react';
                                ...
                                <div className="flex h-full flex-1 flex-col space-y-4 p-4">
                                    <div className="flex h-full flex-col justify-between text-sm">
                                        <div className="flex flex-col space-y-4">
                                            ...
                                            <Link href={route('profile.edit')} className="flex items-center space-x-2 font-medium" prefetch onClick={cleanup}>
